...
<html>
    <head>
        ...
        <script src="Script/empleado.js"></script>
    ...
    <body>
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#crearEmpleado">Crear Empleado</button>
        <br><br>
        <div class="col-sm-14">
            <table class="table">
                <thead>
                    ...
                    <c:forEach var="em" items="${empleados}">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#eliminarEmpleado" onclick="eliminarEmpleado(${em.getId()})">
        ...
        <div class="modal fade" id="editarEmpleado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Formulario para editar un empleado</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="Controlador?menu=Empleado" method="POST">
                            <div class="mb-3">
                                <input type="text" id="codigoEmpleado" name="txtCodigo" class="form-control" hidden="true">
                            </div>
                            <div class="form-group">
                                <label>Tipo de Documento</label>
                                <select name="txtTipoDni" class="form-select" aria-label="Default select example">
                            ...
                            <div class="form-group">
                                <label>Numero de Documento</label>
                                <input type="text" id="documentoEmpleado" name="txtDni" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nombres</label>
                                <input type="text" id="nombreEmpleado" name="txtNombres" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Telefono</label>
                                <input type="text" id="telefonoEmpleado" name="txtTelefono" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Correo Electronico</label>
                                <input type="text" id="emailEmpleado" name="txtEmail" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Nombre de Usuario</label>
                                <input type="text" id="usuarioEmpleado" name="txtUsuario" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>Contraseña</label>
                                <input type="password" name="txtPass" class="form-control">
        ...
        <div class="modal fade" id="eliminarEmpleado" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
